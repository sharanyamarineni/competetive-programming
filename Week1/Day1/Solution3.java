...
public class Solution {
    ...
    public static int highestProductOf3(int[] arr) {
        ...
        int len=arr.length;
        if(len<3){
            throw new IllegalArgumentException("we need to have atleast two values in array");
        }
        // int a1=intArray[0]*intArray[1]*intArray[len];
        // int a2=intArray[len]*intArray[len-1]*intArray[len-2];
