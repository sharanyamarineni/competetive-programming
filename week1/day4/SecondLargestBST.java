...
public class SecondLargestBST {
    ...
    public static void main(String[] args) {
        ...
        BinaryTreeNode b30 =bt.insertLeft(30);
        BinaryTreeNode b40 = b30.insertRight(40);
        BinaryTreeNode b20 = b30.insertLeft(20);
        BinaryTreeNode b80 = bt.insertRight(80);
        BinaryTreeNode b70 = b80.insertLeft(70);
        BinaryTreeNode b90 = b80.insertRight(90);


        SecondLargestBST obj = new SecondLargestBST();
        System.out.println(obj.secondLargest(bt,bt.value,Integer.MIN_VALUE));
    }
